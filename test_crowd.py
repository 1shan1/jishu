...
mae = 0.0
mse = 0.0
output_dir = '/home/pengshanzhen/test_new_people/94/'
gt_count_list =[]
et_count_list =[]
...
attrNet = caffe.Net("/home/pengshanzhen/test_new_people/deploy_dilated_finetune.prototxt", "/home/pengshanzhen/test_new_people/model_iter_270000.caffemodel", caffe.TEST)
...
f = open('/home/pengshanzhen/test_new_people/94/results.txt', 'w') 
